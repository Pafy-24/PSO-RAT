...
\begin{itemize}
\item \textbf{Gestionarea memoriei} — Smart pointers (unique\_ptr, shared\_ptr) și pattern-ul RAII pentru management automat al resurselor
\item \textbf{Semnale de sistem} — Manipularea SIGINT pentru shutdown graceful și cleanup resurse
...
\textbf{ServerManager} — Singleton care coordonează întregul server. Gestionează listener-ul TCP pentru acceptarea clienților noi și menține referințe către toate controller-ele active. Implementează pattern-ul RAII pentru cleanup automat al resurselor la închidere prin destructori.
